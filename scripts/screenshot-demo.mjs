...
try {
  ...
  console.log("Demo browser smoke passed: interactive detail, grouped repeats, resolved targets, read-only controls, mobile overflow. Saved four synthetic screenshots.");
