...
export type PlannerState = { generation?: { id: number; status: string; error: string | null } | null; goals: WeeklyGoals; nextWeekStart: string; currentPlan: SavedWeeklyPlan | null; nextPlan: SavedWeeklyPlan | null };
